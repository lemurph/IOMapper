...
def on_gui_change(x):
    sig_out.set_value(float(int(x)/100))
...
sig_in = dev.add_signal(mpr.DIR_IN, "input", 1, mpr.FLT, None, 0, 100, None, on_change)
sig_out = dev.add_signal(mpr.DIR_OUT, "output", 1, mpr.FLT, None, 0, 1)
